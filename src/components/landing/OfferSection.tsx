...
const offers = [
  ...
  { title: "Meta Ads (Facebook + Instagram)", desc: "Targeted ads to homeowners in your service area — Surrey, Langley, Burnaby, Abbotsford, and beyond. We set up, manage, and optimize every campaign" },
